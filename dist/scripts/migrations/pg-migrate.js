...
(async () => {
    ...
    await pg_connection_1.client.connect();
    const result = await pg_connection_1.client.query(sqlScript);
    console.log(`Migrations applied: ${result.length}`);
    await pg_connection_1.client.end();
    process.exit(0);
})();
